...
let ApiClient = class ApiClient {
    createRequest(method, uri, parameters) {
        ...
        return {
            settings: {
                ...
                body: parameters,
                json: requestHeaders[httpHeader_1.HttpHeader.Accept] === contentType_1.ContentType.ApplicationJson
            }
        };
    }
    responseHandler(request, response, content) {
        return content;
    }
    ...
    execute(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                yield AsyncRequest(request.settings);
            }
            catch (ex) {
                if (ex.statusCode) {
                    response = ex;
                    ...
                    yield this.exceptionHandler(ex);
                }
            }
